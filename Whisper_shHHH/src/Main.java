import MoodAnalyzer.EmotionDecoder;
...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            System.out.println("3. Analyze your message");
            ...
            switch (choice) {
                ...
                case 3 -> {
                    emotion = Utils.input("Enter your message to be analyzed: ");
                    EmotionDecoder.analyzeEmotion(emotion);
